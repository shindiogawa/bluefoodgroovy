package br.com.ogawadev.bluefoodgroovy.application.test
...
class InsertDataForTesting {
    ...
    private Restaurante[] restaurantes() {
        ...
        CategoriaRestaurante categoriaPizza = categoriaRestauranteRepository.findById(1).orElseThrow({ -> new NoSuchElementException() })
        CategoriaRestaurante categoriaSanduiche = categoriaRestauranteRepository.findById(2).orElseThrow({ -> new NoSuchElementException() })
        CategoriaRestaurante categoriaSobremesa = categoriaRestauranteRepository.findById(5).orElseThrow({ -> new NoSuchElementException() })
        CategoriaRestaurante categoriaJapones = categoriaRestauranteRepository.findById(6).orElseThrow({ -> new NoSuchElementException() })
